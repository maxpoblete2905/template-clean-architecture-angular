...
@Component({
    selector: 'app-login',
    standalone: true,
    imports: [MatButtonModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, CommonModule, DataModule],
...
export class LoginComponent {
    ...
    onSubmit() {
        if (this.loginForm.valid) {
            ...
            if (email && password) {
                this.authLoginUseCase.execute(this.loginForm.value).subscribe((data) => {
                    if (data) {
